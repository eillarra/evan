...
PDF_STYLES = {
    "default": ParagraphStyle("default", fontName="IBMPlexSans-Regular", fontSize=10, leading=13, textColor=TEXT_COLOR,)
}

PDF_STYLES["p"] = ParagraphStyle("p", PDF_STYLES["default"], spaceBefore=0.35 * cm, spaceAfter=0.35 * cm,)

PDF_STYLES["p_justify"] = ParagraphStyle("p_justify", PDF_STYLES["p"], alignment=TA_JUSTIFY, hyphenationLang="en_GB",)

PDF_STYLES["p_right"] = ParagraphStyle("p_right", PDF_STYLES["p"], alignment=TA_RIGHT,)

PDF_STYLES["p_small"] = ParagraphStyle("p_small", PDF_STYLES["p"], fontSize=9,)

PDF_STYLES["footer"] = ParagraphStyle(
    "footer", PDF_STYLES["default"], fontSize=7, leading=9, textColor=LIGHT_TEXT_COLOR,
)
...
PDF_STYLES["h2"] = ParagraphStyle(
    "h2", PDF_STYLES["default"], fontSize=16, leading=20, rightIndent=4 * cm, textColor=UGENT_BLUE,
)
