...
event_patterns = (
    [
        path(
            ...
            include(
                [
                    path("", views.PublicEventView.as_view(), name="app"),
                    path(
                        "manage/",
                        include(
                            [
                                path("", EventView.as_view(), name="manage"),
                                path("badges.pdf", views.EventBadgesPdf.as_view(), name="badges"),
                                path("<slug:file_code>.xlsx", views.EventExcelView.as_view(), name="event_excel"),
                                path(
