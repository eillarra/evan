...
class TestImprovedErrorMessages:
    ...
    def test_paper_cross_subsession_error_message_with_internal_id(self, db, t_event):
        ...
        # Setup: Create session with two subsessions and a paper with internal ID
        ...
        # Try to reference the same paper in subsession B
    ...
    def test_paper_cross_subsession_error_message_without_internal_id(self, db, t_event):
        ...
        # Setup: Create session with two subsessions and a paper without internal ID
    ...
    def test_keynote_cross_subsession_error_message(self, db, t_event):
        ...
        # Setup: Create session with two subsessions and a keynote
        ...
        keynote = KeynoteFactory(event=t_event, code="KEYNOTE_001", session=session, subsession=subsession_a)

        # Try to reference the same keynote in subsession B
    ...
    def test_high_order_subsession_roman_numerals(self, db, t_event):
        ...
        # Setup: Create session with high-order subsessions
        ...
        # Verify that high numbers fall back to numeric display
