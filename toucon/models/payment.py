...
class Payment(models.Model):
    """
    A payment for the conference. Payments are linked to registrations.
    """
    ...
    registration = models.ForeignKey('toucon.Registration', related_name='payments', on_delete=models.CASCADE)
