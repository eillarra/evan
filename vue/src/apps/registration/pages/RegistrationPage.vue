<template>
  <div v-if="!loading" class="row q-col-gutter-x-xl q-col-gutter-y-md">
    ...
    <div v-if="mutableRegistration" class="col-12 col-md-7">
      ...
      <ugent-btn
        ...
        color="primary"
        class="q-mt-xl"
        :disable="!formIsValid || preview"
      />
      <q-space class="q-mb-xl" />
    </div>
    <div v-if="registration || preview" class="col-12 col-md sticky top-0">
...
const totalFee = computed<number>(() => {
  ...
  return baseFee + socialEventFee.value;
});
